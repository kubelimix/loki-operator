...
# limix.com/loki-operator-bundle:$VERSION and limix.com/loki-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= limix.com/loki-operator
...
ifeq (,$(shell which ansible-operator 2>/dev/null))
	...
	curl -sSLo $(ANSIBLE_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.19.1/ansible-operator_$(OS)_$(ARCH) ;\
